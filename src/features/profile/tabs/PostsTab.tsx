...
export function PostsTab({ player, posts }: PostsTabProps) {
  return (
    <div className="space-y-3">
      {/* Compose button */}
      <button className="flex w-full items-center gap-3 rounded-2xl border border-dashed border-white/15 bg-white/5 p-4 text-left transition active:scale-[0.98]">
    ...
    <div className="glass p-4">
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1">
          ...
          <p className="text-[11px] text-white/40">{formatDate(post.createdAt)}</p>
        </div>
      </div>
